...
export function buildDeptAggSummaryHtml(deptValue){
  ...
  return '<!DOCTYPE html><html lang="ko"><head><meta charset="UTF-8"><title>설문 응답 요약 — ' + esc4(deptLabel) + '</title><style>'
    ...
    + '.stat-card .lbl{font-size:11px;color:#666;line-height:1.5;}'
    ...
    + '.donut-center span{font-size:11px;color:#666;margin-top:2px;}'
    + '.legend{flex:1;}'
    + '.legend-row{display:flex;align-items:center;gap:10px;padding:8px 0;font-size:12px;border-bottom:1px solid #f5f3ed;}'
    ...
    + '.dom-row{display:grid;grid-template-columns:130px 1fr 100px;align-items:center;gap:14px;padding:10px 0;font-size:12px;border-bottom:1px solid #f5f3ed;}'
    ...
    + 'table{width:100%;border-collapse:collapse;font-size:12px;margin:0 0 28px;background:#fff;border:1px solid #e8dfd0;border-radius:2px;overflow:hidden;}'
    + 'th,td{padding:11px 13px;border-bottom:1px solid #e8dfd0;text-align:left;color:#2a2a2a;}'
    + 'th{background:#f0ebe1;font-size:10px;color:#666;text-transform:uppercase;font-weight:700;letter-spacing:.08em;border-bottom:2px solid #dcd4c5;}'
    + 'tr:hover{background:#fffaf8;}'
    + '.risk-chip{font-family:\'Courier New\',monospace;font-size:10px;padding:3px 7px;border-radius:2px;font-weight:700;white-space:nowrap;margin-right:4px;}'
